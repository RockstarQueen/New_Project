...
IMPLEMENT_DYNAMIC(CMrJackInLondonRule, CDialogEx)

CMrJackInLondonRule::CMrJackInLondonRule(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_HTP, pParent)
{
}

CMrJackInLondonRule::~CMrJackInLondonRule()
{
}

void CMrJackInLondonRule::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CMrJackInLondonRule, CDialogEx)
	ON_WM_PAINT()
	ON_BN_CLICKED(IDC_HTPB_PREV, &CMrJackInLondonRule::OnBnClickedHtpbPrev)
	ON_BN_CLICKED(IDC_HTPB_NEXT, &CMrJackInLondonRule::OnBnClickedHtpbNext)
END_MESSAGE_MAP()
...
BOOL CMrJackInLondonRule::OnInitDialog()
{
...
void CMrJackInLondonRule::OnPaint()
{
...
void CMrJackInLondonRule::OnBnClickedHtpbPrev()
{
	i_page_num--;
	Invalidate();
...
void CMrJackInLondonRule::OnBnClickedHtpbNext()
{
	i_page_num++;
	Invalidate();
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
